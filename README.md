...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=26&pause=1000&color=22D3EE&center=true&vCenter=true&width=760&lines=Hey%2C+I'm+bit_;Python+Developer+%7C+Data+Analyst;FastAPI+%7C+Django+%7C+Web+Scraping;Automation+Workflows+%7C+CS50x+%7C+CS50W)](https://git.io/typing-svg)
...
### Data Analysis
I work with data-driven workflows, structured problem solving, and analytical thinking to explore information, support decisions, and build useful technical outputs.

### Backend Development
I use Python-based frameworks such as FastAPI, Django, and Flask to build APIs, application logic, and maintainable backend services.

### Web Scraping & Automation
I create tools that collect, clean, and process web data, while automating repetitive steps to make workflows faster and more reliable.

### Bots & Utility Systems
I enjoy building command-driven tools and Discord bots that are interactive, practical, and easy to extend.
